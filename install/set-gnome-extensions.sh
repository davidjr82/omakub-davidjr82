...
read -p "To install Gnome extensions, you need to accept some confirmations. Are you ready?"
...
gsettings set org.gnome.shell.extensions.tactile layout-2-col-1 6
...
gsettings set org.gnome.shell.extensions.tactile layout-3-col-1 0
